...
public class GitHubOidcProvider extends OidcProviderBase {
  ...
  @ConfigProperty(name = "vagina.auth.oidc.github.authorize-url", defaultValue = "https://github.com/login/oauth/authorize")
  String authorizeUrl;

  @ConfigProperty(name = "vagina.auth.oidc.github.token-url", defaultValue = "https://github.com/login/oauth/access_token")
  String tokenUrl;

  @ConfigProperty(name = "vagina.auth.oidc.github.userinfo-url", defaultValue = "https://api.github.com/user")
  String userInfoUrl;

  @ConfigProperty(name = "vagina.auth.oidc.github.emails-url", defaultValue = "https://api.github.com/user/emails")
  String emailsUrl;
