...
public class AuthenticationIntegrationTest {
        ...
        public void testHarigataOidcAuthorizationCodeFlow() {
                ...
                Response exchangeResponse = given()
                                .contentType(ContentType.JSON)
                                .body(
                                                Map.of(
                                                                "code",
        ...
        public void testConcurrentHarigataFirstLoginConvergesOnSameUser()
                ...
                CompletableFuture<String> login1 = CompletableFuture.supplyAsync(this::runOidcLoginAndReturnUserId);
                CompletableFuture<String> login2 = CompletableFuture.supplyAsync(this::runOidcLoginAndReturnUserId);
